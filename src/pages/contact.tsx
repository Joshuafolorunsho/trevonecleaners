    ...
    <>
      ...
      <section className="container mx-auto md:pt-8">
        <div className="md:flex">
          <div className="flex-1 bg-primary-500 p-4 pt-8">
            <div className="flex items-center">
              ...
              <p className="font-bold text-white">081 611 65 391</p>
            </div>

            <p className="pl-12 text-primary-50">Drop us a call</p>
          </div>
          <div className="flex-1 bg-primary-50 p-4 pt-8">
            <div className="flex items-center">
              <span>
                <svg
                  width="42"
          ...
          <div className="flex-1 bg-primary-500 p-4 pt-8">
            ...
            <p className="pl-12 pt-3 text-primary-50">Pay us a visit</p>
          </div>
        </div>
      </section>
