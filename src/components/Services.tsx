    ...
    <section className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
      {services.map((service) => (
        ...
        >
          ...
          <div className="group relative z-10 mt-[320px] h-full flex-col justify-end rounded-full px-6 hover:mt-[0] hover:flex hover:backdrop-blur-sm">
            ...
            <p className="hidden leading-7 tracking-wide group-hover:block">{service.text}</p>
            <LinkButton href="" variant="primary" className="my-5 hidden w-fit group-hover:block">
              Read more
            </LinkButton>
          </div>
        </div>
